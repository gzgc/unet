...
from utils.dataset import BasicDataset,Img_json_data,Data_Loader
...
def train_net(net, cfg):
    #dataset = Img_json_data("../dataset//water_gauge2//001_GD//labels//segmentation//jsons")
    dataset = Data_Loader("../dataset//watergauge_web_bms_img56")
            ...
            for batch in train_loader:
                ...
                if global_step % (len(dataset) // (10 * cfg.batch_size)) == 0:
                    ...
                    if cfg.n_classes == 1:
                        ...
                        #writer.add_images('masks/inference',inference_mask,global_step)
                    else:
                        # writer.add_images('masks/true', batch_masks, global_step)
                        ...
                        for idx in range(0, len(inference_masks)):
                            ...
                            #writer.add_images('masks/inference_'+str(idx),inference_mask,global_step)
