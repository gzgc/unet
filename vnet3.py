...
class VNet(nn.Module):
    def __init__(self,in_channels,out_channels):
        ...
        self.bone = DoubleConv(in_channels,30)

        self.down1 = Passthrow(30,60) # w/2,h/2,64  128*64
        self.down2 = Passthrow(60,80) #w/4,..,128   64*128
        self.down3 = Passthrow(80,100)#             32*256
        self.down4 = Passthrow(100,120)#             16*512
        ...
        self.outc = OutConv(70, out_channels)
    def forward(self,x):
