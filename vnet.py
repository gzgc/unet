...
class Down(nn.Module):
    def __init__(self,in_channels,out_channels):
        ...
        self.down = nn.Sequential(
            nn.Conv2d(in_channels,out_channels//4*3,kernel_size=3,stride=2,padding=1,bias=False),
            nn.BatchNorm2d(out_channels//4*3),
            nn.ReLU(inplace=True),

            nn.Conv2d(out_channels//4*3,out_channels//4*3,kernel_size=1,bias=False),
            nn.BatchNorm2d(out_channels//4*3),
            nn.ReLU(inplace=True))
        
        self.down1 = nn.Sequential(
            nn.Conv2d(in_channels,out_channels//4*3,kernel_size=2,stride=2,padding=0,bias=False),
            nn.BatchNorm2d(out_channels//4*3),
            nn.ReLU(inplace=True),
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(out_channels//2*3,out_channels,kernel_size=1,bias=False),
...
class VNet(nn.Module):
    def __init__(self,in_channels,out_channels):
        ...
        self.bone = FirstBone(in_channels) # w*h*48  256 * 48
